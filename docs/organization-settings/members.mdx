...
The members list uses infinite scrolling, automatically loading more members as you scroll down the list. This replaces the earlier fixed display of the first 50 members, allowing you to view the entire organization without pagination.
