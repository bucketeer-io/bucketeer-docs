...
- **[Slack](/organization-settings/slack)** - Set up Slack notifications for important events
- **[FCM](/organization-settings/fcm)** - Configure Firebase Cloud Messaging for real-time flag updates
