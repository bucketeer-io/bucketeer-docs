...
Segments enable you to create user groups based on the unique ID of end users defined when initializing the Bucketeer SDK.<br />
...
You can use segments to target specific user groups and make a new feature only available to them.<br />
For example, before releasing a new feature, the QA team may need to test it. In such a situation, you can create a segment with all QA team members' IDs and make the new feature only available to them.
...
1. Navigate to the **User Segments** menu and click on **+ Add**.
...
1. Download the existing list by clicking on the action menu (three dots) on the list page and selecting **Download user list**.
2. Edit the list locally on your PC.
...
1. Navigate to the **User Segments** menu.
2. Find the desired segment, click the action button (three dots) on the list page, and select **Delete segment**.
