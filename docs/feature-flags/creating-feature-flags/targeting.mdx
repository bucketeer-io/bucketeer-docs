...
Bucketeer supports semantic versioning (SemVer) for attributes like `app_version`. You can use SemVer in targeting rules to control feature rollout based on application versions.
:::
