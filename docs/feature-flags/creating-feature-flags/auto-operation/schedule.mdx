...
Selecting the **Update now** radio button applies the change instantly, invoking the direct flag update operation instead of creating a scheduled auto‐operation. This allows you to toggle the flag without waiting for a scheduled time.
