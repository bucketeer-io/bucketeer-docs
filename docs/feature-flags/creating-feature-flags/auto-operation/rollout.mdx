...
description: 'The rollout features'
tags: ['guide', 'automation', 'rollout', 'feature-flag']
---

import CenteredImg from '@site/src/components/centered-img/CenteredImg';

The rollout solution is designed to progressively deliver new features for your users. It automates the release process, gradually providing the flag variation you choose to a larger percentage of your users to ensure it performs as expected. You can use this approach to detect problems earlier and reduce the impact of any issue.

When you choose to use the rollout option, you are selecting an enabling operation from the [Auto Operation](/feature-flags/creating-feature-flags/auto-operation/auto-operation). That means that you will choose the flag variation that more users will receive as time goes on and the rollout approaches its end.
