...
- **Operation**: An action triggered by one or more conditions. When the condition is met, the action related to the operation is executed. Currently, Bucketeer supports two types of operations:
  ...
  - **Enable**: Enables the chosen flag when the condition is met. You can release using the **[schedule](/feature-flags/creating-feature-flags/auto-operation/schedule)** or **[progressive rollout](/feature-flags/creating-feature-flags/auto-operation/progressive-rollout)** options.
