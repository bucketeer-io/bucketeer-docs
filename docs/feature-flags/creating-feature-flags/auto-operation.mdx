...
1. **Operation**: An operation is an action that is triggered by the condition. The available operations are:
   ...
   - _Enable feature_: Activates the flag.
   - _Kill feature_: Desables the flag.
...
<CenteredImg
  imgURL="img/feature-flags/auto-ops-rules/schedule-condition.png"
...
<CenteredImg
  imgURL="img/feature-flags/auto-ops-rules/event-rate-condition.png"
  alt="Event rate panel"
  wSize="500px"
/>
...
<CenteredImg
  imgURL="img/feature-flags/auto-ops-rules/create-condition.png"
  alt="Event rate panel"
  wSize="500px"
/>
