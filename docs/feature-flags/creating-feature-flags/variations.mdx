...
YAML is now offered as a selectable variation type. It lets you include comments inside the variation value, which can make complex configurations easier to read. When you choose YAML in the dashboard, the variation behaves like other object‐type variations while providing the added benefit of comment support.
