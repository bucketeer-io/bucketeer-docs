...
- You can't add variations if you have an active [progressive rollout](/feature-flags/creating-feature-flags/auto-operation/progressive-rollout) with the current flag. However, you can edit the values, names, and descriptions of the existing variations.
