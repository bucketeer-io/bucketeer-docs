...
Bucketeer offers OpenFeature providers for several languages, enabling developers to evaluate flags through the OpenFeature API. The available providers include Swift, Kotlin, Go, JavaScript, and Node.js.
