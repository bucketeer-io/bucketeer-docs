...
<div className="row" style={{maxWidth: '500px'}}>
  ...
  <div className="col--3 text--center">
    <a href="/sdk/client-side/react" className="brand-link">
      <i className="react-icon brand-icon"></i>
      <span>React</span>
    </a>
  </div>

  <div className="col--3 text--center">
    <a href="/sdk/client-side/react-native" className="brand-link">
      <i className="react-native-icon brand-icon"></i>
  ...
  <table>
    <thead>
      <tr>
        ...
        <th><a href="/sdk/client-side/react">React</a></th>
        <th><a href="/sdk/client-side/react-native">React Native</a></th>
      </tr>
    </thead>
    <tbody>
      <tr>
...
<div className="sdk-table">
  <table>
    <thead>
      <tr>
        <th>Feature</th>
        <th><a href='/sdk/server-side/go'>Go</a></th>
        <th><a href='/sdk/server-side/node-js'>Node Js</a></th>
      </tr>
    </thead>
    <tbody>
      <tr>
...
Bucketeer supports the vendor-neutral [OpenFeature](https://openfeature.dev) standard, allowing you to use Bucketeer with any OpenFeature-compatible SDK. This provides flexibility to switch between feature flag providers without changing your application code.

Supported OpenFeature providers:

<div className="row">

  <div className="col col--3 text--center">
    <a href="/open-feature/android" className="brand-link">
      <i className="android-icon brand-icon"></i>
      <span>Android</span>
    </a>
  </div>
  ...
  <div className="col col--3 text--center">
    <a href="/open-feature/ios" className="brand-link">
      <i className="ios-icon brand-icon"></i>
      <span>iOS</span>
    </a>
  </div>
  ...
  <div className="col col--3 text--center">
    <a href="/open-feature/javascript" className="brand-link">
      <i className="javascript-icon brand-icon"></i>
      <span>JavaScript</span>
    </a>
  </div>
  ...
  <div className="col col--3 text--center">
    <a href="/open-feature/react" className="brand-link">
      <i className="react-icon brand-icon"></i>
      <span>React</span>
    </a>
  </div>
...
<div className="row margin-top--sm">
  ...
  <div className="col col--3 text--center">
    <a href="/open-feature/react-native" className="brand-link">
      <i className="react-native-icon brand-icon"></i>
      <span>React Native</span>
    </a>
  </div>
  ...
  <div className="col col--3 text--center">
    <a href="/open-feature/go" className="brand-link">
      <i className="golang-icon brand-icon"></i>
      <span>Go</span>
    </a>
  </div>
  ...
  <div className="col col--3 text--center">
    <a href="/open-feature/node-js" className="brand-link">
      <i className="nodejs-icon brand-icon"></i>
      <span>Node.js</span>
    </a>
  </div>
...
[View all OpenFeature integrations](https://openfeature.dev/ecosystem?instant_search%5BrefinementList%5D%5Bvendor%5D%5B0%5D=Bucketeer) in the OpenFeature ecosystem.

:::

The TypeScript evaluation package is released through a manual GitHub Actions workflow that uses npm OIDC trusted publishing. The workflow builds the package and publishes it without requiring an NPM_TOKEN; the legacy token configuration has been removed. To publish a new version, update the version in `package.json`, merge to `main`, and trigger the “Publish TypeScript evaluation to npm” workflow, optionally enabling dry run.
