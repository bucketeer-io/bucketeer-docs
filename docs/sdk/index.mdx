...
<div className="row" style={{maxWidth: '900px', display: 'flex', flexWrap: 'nowrap'}}>

  <div className="col text--center" style={{flex: '1'}}>
    <a href="https://github.com/bucketeer-io/openfeature-js-client-sdk" className="brand-link" target="_blank" rel="noopener noreferrer">
      <i className="javascript-icon brand-icon"></i>
  ...
  <div className="col text--center" style={{flex: '1'}}>
    <a href="https://github.com/bucketeer-io/openfeature-swift-client-sdk" className="brand-link" target="_blank" rel="noopener noreferrer">
      <i className="ios-icon brand-icon"></i>
      <span>Swift</span>
    </a>
  </div>
  ...
  <div className="col text--center" style={{flex: '1'}}>
    <a href="https://github.com/bucketeer-io/openfeature-kotlin-client-sdk" className="brand-link" target="_blank" rel="noopener noreferrer">
      <i className="android-icon brand-icon"></i>
      <span>Kotlin</span>
    </a>
  </div>
  ...
  <div className="col text--center" style={{flex: '1'}}>
    <a href="https://github.com/bucketeer-io/openfeature-go-server-sdk" className="brand-link" target="_blank" rel="noopener noreferrer">
      <i className="golang-icon brand-icon"></i>
      <span>Go</span>
    </a>
  </div>
  ...
  <div className="col text--center" style={{flex: '1'}}>
    <a href="https://github.com/bucketeer-io/openfeature-node-server-sdk" className="brand-link" target="_blank" rel="noopener noreferrer">
      <i className="nodejs-icon brand-icon"></i>
      <span>Node.js</span>
    </a>
  </div>
