...
**1.** Open iOS folder, using Xcode IDE to open the file `Runner.xcworkspace`.<br />
**2.** Open XCode project setting.<br />
**2.** Select the `Runner` target.<br />
**2.** Select the `Signing & Capabilities` tab.<br />
**3.** Looking for the `Background Modes` section and enable the `Background processing` option.<br />
...
-  
**5.** If needed, change the background polling default interval by adding the `backgroundPollingInterval` setting in the **BKTConfigBuilder** as follows:
...
- iOS documentation for setup background tasks ([iOS Documentation](https://developer.apple.com/documentation/uikit/app_and_environment/scenes/preparing_your_ui_to_run_in_the_background/using_background_tasks_to_update_your_app)).<br />
