...
* latency metrics should reflect only the most recent (final) network request attempt ([#325](https://github.com/bucketeer-io/javascript-client-sdk/issues/325)) ([15aad25](https://github.com/bucketeer-io/javascript-client-sdk/commit/15aad2507b7468879f8f41955bcedb2440301dec))
* measure latencySecond with monotonic high-resolution clock ([#322](https://github.com/bucketeer-io/javascript-client-sdk/issues/322)) ([2c21376](https://github.com/bucketeer-io/javascript-client-sdk/commit/2c21376f6b011d5adaa5dbca5448d8504dc8ea46))
