...
<ButtonShelf>
  <Button
    redirect="/getting-started/quickstart/create-an-api-key"
    title="1. Create an API key"
    info="Create an API key to be used on the integration of your first feature flag."
  />
  <Button
    redirect="/getting-started/quickstart/create-your-first-flag"
  ...
  />
  <Button
    redirect="/getting-started/quickstart/integrate-bucketeer"
