...
- **ID**: This unique identifier is used to identify the feature flag when adding it to your application. In code examples, the ID is also referenced as `FLAG_ID`. It has a maximum length of 100 characters.
...
With the API key and the feature flag ID, you can follow to the next step and [integrate Bucketeer](./integrate-bucketeer) to your application.
