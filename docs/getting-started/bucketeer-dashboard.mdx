...
- **Feature Flags**: this section displays all the feature flags within the selected project. You can choose a flag to manage its environment-specific targeting and rollout rules.
...
The image below presents the sidebar with all the options listed and described above.

![Bucketeer dashboard sidebar](./img/dashboard-sidebar.png)
