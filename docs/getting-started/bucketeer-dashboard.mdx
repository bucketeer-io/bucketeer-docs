...
- **Feature Flags**: this section displays all the flags within the selected project. You can choose a flag to manage its environment-specific targeting and rollout rules. When you toggle a flag, you can select "Update now" to apply the change immediately, or choose "Schedule" to create a scheduled auto‐operation that will apply the change at a later time.
