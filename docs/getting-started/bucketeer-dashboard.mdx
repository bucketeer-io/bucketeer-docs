...
- **Feature Flags**: this section displays all the flags within the selected project. You can choose a flag to manage its environment-specific targeting and rollout rules. The flag switch confirmation modal no longer includes a schedule option, and the comment and reset-sampling fields are always shown.
